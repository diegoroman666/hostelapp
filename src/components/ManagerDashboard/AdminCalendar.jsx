                                ...
                                <>
                                    ...
                                    <div style={{ display: 'flex', flexDirection: 'column', gap: '0.3rem' }}>
                                        {item.bookings.map(booking => {
                                            // Extraer color basado en el nombre de la habitación (si está disponible en joined data)
                                            // Como es una demo rápida, usaremos un color por defecto o lógica simple
